        ...
        while True:
            ...
            try:
                ...
                if 0 <= idx < len(emails):
                    ...
                    print(f"文件夹: {'已发送' if email.get('folder') == 'sent' else '收件箱'}")
                    ...
                    if email_content:
                        ...
                        if email_content.get('html_content'):
                            ...
                            if view_html:
                                ...
                                print("\n" + (email_content.get('text_content') or "无纯文本内容"))
                        else:
                        ...
                        if attachments:
                            ...
                            for i, attachment in enumerate(attachments):
                                print(f"{i+1}. {attachment.get('filename')} ({attachment.get('content_type')})")
                    else:
                        print("\n无法获取邮件内容")
                else:
                    print("无效的ID")
